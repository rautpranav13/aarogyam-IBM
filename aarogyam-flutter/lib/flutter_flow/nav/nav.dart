...
const debugRouteLinkMap = {
  ...
  '/firstAid':
      'https://app.flutterflow.io/project/health-literacy-c97mzb?tab=uiBuilder&page=FirstAid',
  '/authHome':
  ...
  '/authLogin':
      'https://app.flutterflow.io/project/health-literacy-c97mzb?tab=uiBuilder&page=auth_Login',
  '/authForgotPassword':
  ...
  '/allergiesPAgeCopy':
      'https://app.flutterflow.io/project/health-literacy-c97mzb?tab=uiBuilder&page=AllergiesPAgeCopy',
  '/authUserInfo':
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ReportSanner',
          path: '/reportSanner',
          builder: (context, params) => ReportSannerWidget(
        ...
        FFRoute(
          name: 'FirstAid',
          path: '/firstAid',
          builder: (context, params) => FirstAidWidget(),
        ),
        FFRoute(
          name: 'auth_home',
          path: '/authHome',
        ...
        FFRoute(
          ...
          builder: (context, params) => AllergiesPAgeCopyWidget(),
        ),
        FFRoute(
          name: 'auth_userInfo',
          path: '/authUserInfo',
          builder: (context, params) => AuthUserInfoWidget(),
        ),
        FFRoute(
          name: 'Allergies',
          path: '/allergies',
        ...
        FFRoute(
          name: 'CustomQuery',
          path: '/customQuery',
          builder: (context, params) => CustomQueryWidget(),
        ),
        FFRoute(
          name: 'dbpageee',
          path: '/dbpageee',
          builder: (context, params) => DbpageeeWidget(),
        )
